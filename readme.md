...
6. doing this and waiting about 2-3 minuets (hyperbole for precaution) will then start the website in your default browser (I recommend chrome). If this dose not happen the website can be reached at : http://localhost:3000
