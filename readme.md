...
1.a.'./database/Generate_Database.sql' simply generates a schema called 'twitter'
1.b.'./database/insert.sql' creates fake uses and interactions between those use such as tweeting, liking, reposting and following.
